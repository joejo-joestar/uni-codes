...
CREATE TABLE
    Admission (E_No INT PRIMARY KEY AUTO_INCREMENT, E_Name VARCHAR(32), Age INT, Department VARCHAR(32), DateofAdm DATE, Fee INT, Sex CHAR(1));

INSERT INTO
    Admission (E_No, E_Name, Age, Department, DateofAdm, Fee, Sex)
VALUES
