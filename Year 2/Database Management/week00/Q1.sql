...
CREATE TABLE
    department (dept_name VARCHAR(32), building VARCHAR(32), budget DOUBLE);
...
CREATE TABLE
    takes (`SID` VARCHAR(32) PRIMARY KEY, course_id VARCHAR(32), sec_id VARCHAR(16), semester INT, YEAR INT, grade CHAR(2));
...
VALUES
    ("Computer Science", "Main Block", 100000);