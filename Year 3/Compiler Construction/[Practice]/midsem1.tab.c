...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VAR = 3,                        /* VAR  */
  YYSYMBOL_EQ = 4,                         /* EQ  */
  YYSYMBOL_SQLP = 5,                       /* SQLP  */
  YYSYMBOL_SQRP = 6,                       /* SQRP  */
  YYSYMBOL_LP = 7,                         /* LP  */
  YYSYMBOL_RP = 8,                         /* RP  */
  ...
  YYSYMBOL_X = 13,                         /* X  */
  YYSYMBOL_S = 14,                         /* S  */
  YYSYMBOL_EXPR_LINE = 15,                 /* EXPR_LINE  */
  YYSYMBOL_E = 16,                         /* E  */
  YYSYMBOL_P = 17                          /* P  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VAR", "EQ", "SQLP",
  "SQRP", "LP", "RP", "PRINT", "COMMA", "STR", "$accept", "X", "S",
  "EXPR_LINE", "E", "P", YY_NULLPTR
};
